 ...
 */
var AppMenu = (_dec = (0, _cn2.default)('app'), _dec2 = (0, _performance2.default)(), _dec(_class = _dec2(_class = (_temp = _class2 = function (_React$Component) {
        ...
        value: function render(cn) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: cn('menu-case') },
                    _react2.default.createElement(
                        'div',
                        { className: cn('menu-content') },
                        this.props.children
                    )
                )
            );
