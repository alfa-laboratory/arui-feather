...
case "${SAUCE_CONNECT_PLATFORM}" in
    linux)
        ...
        SC_DISTRIBUTION_SHASUM=dc5efcd2be24ddb099a85b923d6e754754651fa8;;
    osx)
        SC_DISTRIBUTION_FMT=zip
        SC_DISTRIBUTION_SHASUM=67d05407c31dc00ee60b8ab65d7ced93d6fa610f;;
esac
SC_DISTRIBUTION=sc-4.5.4-${SAUCE_CONNECT_PLATFORM}.${SC_DISTRIBUTION_FMT}
