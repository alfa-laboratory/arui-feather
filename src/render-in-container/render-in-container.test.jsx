...
describe('render-in-container', () => {
    it('should place children in body when `container` prop not set', () => {
        const renderInContainer = mount(
            <RenderInContainer>
                <div>Render-test</div>
            </RenderInContainer>
        );

        const contentNode = renderInContainer.instance().getNode();
    ...
    describe('with custom container', () => {
        ...
        beforeEach(() => {
            const renderContainerNode = document.createElement('div');
        ...
        afterEach(() => {
            const renderContainerNode = getRenderContainer();
        ...
        it('should render empty component and place it in container set via `container` prop', () => {
            ...
            const contentNode = renderInContainer.instance().getNode();
            const containerNode = renderInContainer.instance().getContainer();
