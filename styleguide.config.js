...
module.exports = {
    ...
    styleguideComponents: {
        'StyleGuide$': path.resolve(__dirname, './node_modules/arui-demo/styleguide/styleguide'),
        StyleGuideRenderer: path.resolve(__dirname, './node_modules/arui-demo/styleguide/styleguide-renderer'),
        SectionHeadingRenderer: path.resolve(__dirname, './node_modules/arui-demo/section-heading/section-heading-renderer'),
        Markdown: path.resolve(__dirname, './node_modules/arui-demo/markdown'),
        Preview: path.resolve(__dirname, './node_modules/arui-demo/preview'),
        Editor: path.resolve(__dirname, './node_modules/arui-demo/editor/editor'),
        Pathline: path.resolve(__dirname, './node_modules/arui-demo/pathline'),
        'slots$': path.resolve(__dirname, './node_modules/arui-demo/slots'),
        'ReactComponent$': path.resolve(__dirname, './node_modules/arui-demo/react-component'),
    },
    template: {
