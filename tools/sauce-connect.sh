...
case "${SAUCE_CONNECT_PLATFORM}" in
    linux)
        ...
        SC_DISTRIBUTION_SHASUM=edb6816c873cc4cdf1d099e1534778d35f184942;;
    osx)
        SC_DISTRIBUTION_FMT=zip
        SC_DISTRIBUTION_SHASUM=6f3e693135294e536cd99fc9f9d3b55532c68172;;
esac
SC_DISTRIBUTION=sc-4.4.7-${SAUCE_CONNECT_PLATFORM}.${SC_DISTRIBUTION_FMT}
